    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    res.status(400).send({ status: 400, message: error_1 });
                    return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, typeorm_1.getRepository(User_1.User).find({ where: { firstName: name } })];
                case 1:
                    users = _a.sent();
                    res.json(users);
                    return [2 /*return*/];
...
router.get('/', function (req, res, next) {
    res.status(200).json({
        message: "Here we are handling the get request for the users"
    });
});
